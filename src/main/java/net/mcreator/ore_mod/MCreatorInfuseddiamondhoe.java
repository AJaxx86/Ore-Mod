...
public class MCreatorInfuseddiamondhoe extends Elementsore_mod.ModElement {
	@ObjectHolder("ore_mod:infuseddiamondhoe")
	public static final Item block = null;

	public MCreatorInfuseddiamondhoe(Elementsore_mod instance) {
		super(instance, 15);
	}
